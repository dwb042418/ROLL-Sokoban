...
class DeepSpeedTrainStrategy(DeepSpeedInferStrategy, TrainStrategy):
    ...
    def initialize(self, model_provider):
        ...
        # Use standard Adam to avoid CUDA compilation issues with FusedAdam
        # FusedAdam requires compatible CUDA toolchain which may not be available
        from torch.optim import Adam as TorchAdam
        adam_optimizer = DeepSpeedCPUAdam if self.ds_config.is_offload() else TorchAdam

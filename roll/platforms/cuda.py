...
class CudaPlatform(Platform):
    ...
    def get_custom_env_vars(cls) -> dict:
        ...
        # 传递模型下载相关的环境变量
        if "MODEL_DOWNLOAD_TYPE" in os.environ:
            env_vars["MODEL_DOWNLOAD_TYPE"] = os.environ["MODEL_DOWNLOAD_TYPE"]
        if "HF_HUB_ENABLE_HF_TRANSFER" in os.environ:
            env_vars["HF_HUB_ENABLE_HF_TRANSFER"] = os.environ["HF_HUB_ENABLE_HF_TRANSFER"]
        if "HF_ENDPOINT" in os.environ:
            env_vars["HF_ENDPOINT"] = os.environ["HF_ENDPOINT"]
